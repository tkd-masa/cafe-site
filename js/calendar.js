...
function showProcess(date) {
    ...
    document.querySelector('.cal_header').innerHTML = "<span class='year'>" + year + "</span>" + "<span class='month_num'>" + (month + 1) + "</span>" + "<span class='month'>" + new Intl.DateTimeFormat('en', { month: 'long'}).format(date).slice(0,3) + "</span>";
